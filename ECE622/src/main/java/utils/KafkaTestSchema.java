...
public class KafkaTestSchema implements KafkaSerializationSchema<Tuple5<String,Double,Double,Double,Double>>, KafkaDeserializationSchema<String> {
    ...
    //TODO ADD SIGNAL AND TERMINATE Stream
    @Override
